    ...
    <main className="min-h-full overflow-hidden bg-[#030604] pb-24 text-white">
      <header className="relative px-4 pb-6 pt-4">
        ...
        <div className="relative z-10 flex items-center justify-between">
          ...
          <div className="flex h-11 w-11 items-center justify-center overflow-hidden rounded-2xl border border-[#15EA3E]/25 bg-[#15EA3E]/10">
            <img src="/zandofyiconeapp.png" alt="" className="h-full w-full scale-[1.25] object-cover" />
          </div>
        </div>
        ...
        <div className="relative z-10 mt-8">
          ...
          <p className="mt-3 max-w-[290px] text-sm font-semibold leading-relaxed text-white/52">
            Un espace boutique personnalise, separe du Market general, pour les collections et offres Zandofy.
          </p>
        </div>
      </header>
        ...
        <div className="relative overflow-hidden rounded-[1.9rem] border border-[#15EA3E]/18 bg-[#071007] p-5">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-2 text-sm font-semibold leading-relaxed text-white/48">
              Les produits Zandofy seront affiches ici dans une experience boutique dediee, differente du Market principal.
            </p>
      ...
      <section className="px-4 pt-5">
        <div className="scrollbar-hide flex gap-3 overflow-x-auto pb-1">
          {['Collections', 'Offres flash', 'Createurs', 'Services'].map((label) => (
