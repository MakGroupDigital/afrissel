...
export default function WalletDashboard() {
  ...
  const transactions = [
    { id: 1, type: 'credit', name: 'Recharge M-Pesa', date: "Aujourd'hui, 09:41", amount: 50.00, icon: 'phone' as AfriSellIconName },
    { id: 2, type: 'debit', name: 'Achat Market - Wax', date: "Hier, 14:20", amount: -65.00, icon: 'market' as AfriSellIconName },
    { id: 3, type: 'credit', name: 'Recharge Orange Money', date: "02 Mai, 18:10", amount: 120.00, icon: 'phone' as AfriSellIconName },
    { id: 4, type: 'debit', name: 'Achat ABC - Casque', date: "28 Avril, 11:30", amount: -85.00, icon: 'video' as AfriSellIconName },
  ];
    ...
    <div className="min-h-full bg-[#000000] p-4 flex flex-col gap-6">
      ...
      <div className="relative w-full aspect-[1.586] rounded-2xl p-5 flex flex-col justify-between overflow-hidden border border-gray-800"
        ...
        <div className="relative z-10 flex items-end justify-between mt-auto">
          <div className="flex flex-col">
            <p className="text-gray-400 text-[10px] mb-1 font-mono tracking-[0.3em] opacity-80">**** **** **** 4812</p>
               ...
               return (
                 <div key={tx.id} className="flex items-center justify-between p-3 bg-[#0A0A0A] rounded-xl border border-gray-800 hover:border-gray-700 transition-colors cursor-pointer group">
                    <div className="flex items-center gap-3">
                       ...
                       <div className="flex flex-col">
                          <span className="text-gray-300 font-medium text-xs font-sans tracking-wide">{tx.name}</span>
                          <span className="text-gray-600 text-[10px] font-mono mt-0.5">{tx.date}</span>
                       </div>
                    </div>
                    <div className={cn(
